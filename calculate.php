...
.sp-input:focus { outline: none; border-color: var(--success); box-shadow: 0 0 0 3px rgba(90,138,122,.1); }
...
.mc-b .mc-icon { background: rgba(90,122,155,.10);        color: #5A7A9B; }
