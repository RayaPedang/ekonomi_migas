...
<style>
:root{
    --bg:#0C0C0C;--bg2:#141414;--card:#1A1A1A;--border:#272727;
    --accent:#938A87;--accent-h:#B0A8A5;--accent-bg:rgba(147,138,135,.08);--accent-bdr:rgba(147,138,135,.22);
    --text:#EDEAE6;--text2:#B8B3AE;--muted:#605E5E;--dim:#7A7572;
    --success:#6E9B7A;--danger:#9B6E6E;
}
...
.btn-nav:hover{background:var(--accent-h);color:var(--bg);transform:translateY(-1px)}
...
.hero-wm{position:absolute;font-size:38vw;font-weight:800;color:rgba(255,255,255,.011);
...
/* top fade */
.hero-fade{position:absolute;top:0;left:0;right:0;height:180px;
    background:linear-gradient(to bottom,var(--bg),transparent);pointer-events:none;z-index:1}
...
/* headline */
.hero-h1{font-size:clamp(46px,8.5vw,92px);font-weight:800;line-height:1.03;
...
.hero-h1 .ln3{color:var(--dim);font-weight:400;font-size:.58em;
    letter-spacing:-.02em;display:block;margin-top:.15em}

/* desc */
.hero-p{font-size:clamp(14.5px,1.8vw,17px);color:var(--dim);line-height:1.72;
    font-weight:400;margin-bottom:2.5rem;max-width:520px;margin-left:auto;margin-right:auto}

/* CTAs */
.hero-ctas{display:flex;align-items:center;justify-content:center;
    gap:.9rem;margin-bottom:2.8rem;flex-wrap:wrap}
.btn-primary{padding:14px 28px;border-radius:10px;background:var(--accent);color:var(--bg);
...
.btn-secondary{padding:14px 28px;border-radius:10px;background:transparent;
    border:1px solid var(--border);color:var(--text2);
    font-size:15px;font-weight:500;text-decoration:none;
    display:flex;align-items:center;gap:8px;transition:.18s all}
.btn-secondary:hover{border-color:var(--accent-bdr);color:var(--accent);background:var(--accent-bg)}
...
/* scroll indicator */
.scroll-ind{position:absolute;bottom:2.5rem;left:50%;transform:translateX(-50%);
    z-index:2;display:flex;flex-direction:column;align-items:center;gap:6px}
.si-label{font-size:10px;color:var(--muted);text-transform:uppercase;letter-spacing:.14em;
    font-family:'DM Mono',monospace}
.si-line{width:1px;height:38px;
...
.stat{padding:2.2rem 2.5rem;border-right:1px solid var(--border);
    transition:.18s background;cursor:default}
.stat:last-child{border-right:none}
.stat:hover{background:rgba(255,255,255,.018)}
.stat-n{font-family:'DM Mono',monospace;font-size:40px;font-weight:500;
...
.sec-label{font-family:'DM Mono',monospace;font-size:10.5px;font-weight:500;
...
.sec-title{font-size:clamp(26px,4vw,38px);font-weight:700;letter-spacing:-.035em;
    color:var(--text);margin-bottom:.75rem;line-height:1.1}
.sec-desc{font-size:14.5px;color:var(--dim);line-height:1.65}
.sec-hdr{display:flex;align-items:flex-end;justify-content:space-between;
    margin-bottom:2.2rem;gap:1rem}
.btn-all{font-size:13px;color:var(--accent);text-decoration:none;font-weight:500;
...
.pc{background:var(--card);border:1px solid var(--border);border-radius:14px;
...
.pc-name{font-size:15.5px;font-weight:600;color:var(--text);margin-bottom:.85rem;
...
.btn-pc{flex:1;padding:8px 10px;border-radius:8px;font-size:13px;font-weight:600;
...
.pc-new{min-height:195px;display:flex;align-items:center;justify-content:center;
    border-style:dashed!important;background:transparent!important;cursor:pointer;
...
.btn-start{display:inline-flex;align-items:center;gap:7px;
...
.feat{background:var(--card);border:1px solid var(--border);border-radius:14px;
...
.feat-ico{width:40px;height:40px;background:var(--accent-bg);border:1px solid var(--accent-bdr);
...
/* ═══ FORMULA SECTION ═══════════════════════════════════════ */
.formula-inner{max-width:1120px;margin:0 auto;
    display:grid;grid-template-columns:1fr 1fr;gap:4rem;align-items:start}
.formula-block{background:var(--card);border:1px solid var(--border);border-radius:14px;
...
.mprev-l{font-size:10px;color:var(--muted);text-transform:uppercase;
    letter-spacing:.1em;margin-bottom:.35rem;font-family:'DM Mono',monospace}
.mprev-v{font-family:'DM Mono',monospace;font-size:21px;font-weight:500;
    color:var(--text);letter-spacing:-.03em}
.mprev-v.pos{color:var(--success)}.mprev-v.neu{color:var(--text2)}
.mprev-s{font-size:11px;color:var(--muted);margin-top:.3rem}

/* ═══ FOOTER ════════════════════════════════════════════════ */
footer{padding:2.25rem 2rem;border-top:1px solid var(--border);
    display:flex;align-items:center;justify-content:space-between;
...
.footer-logo{width:28px;height:28px;background:var(--accent);border-radius:6px;
    display:flex;align-items:center;justify-content:center;
...
<section class="hero">
    ...
    <div class="hero-inner">
        ...
        <div class="hero-ctas">
            ...
            <a href="project.php" class="btn-secondary">
...
<script>
// Navbar becomes fully opaque on scroll
